...
#define WL28681_DESC(_id, _match, _supply, _min, _max, _step, _vreg, _vmask, \
		     _ereg, _emask, _enval, _disval, _curr_table, _creg,     \
		     _cmask, _minsel)                                        \
	{                                                                    \
		.id = (_id),                                                 \
		.name = (_match),                                            \
...
static const struct regulator_desc wl28681_reg[] = {
	WL28681_DESC(WL28681_REGULATOR_LDO1, "WL_LDO1", "vin12", 496, 2048, 8,
		     WL28681_LDO1_VOUT, WL28681_VSEL_MASK, WL28681_LDO_EN,
		     BIT(0), BIT(0), 0, wl28681_crtable1, WL28681_ILIM, BIT(0),
		     61),
	WL28681_DESC(WL28681_REGULATOR_LDO2, "WL_LDO2", "vin12", 496, 2048, 8,
		     WL28681_LDO2_VOUT, WL28681_VSEL_MASK, WL28681_LDO_EN,
		     BIT(1), BIT(1), 0, wl28681_crtable2, WL28681_ILIM, BIT(1),
		     61),
	WL28681_DESC(WL28681_REGULATOR_LDO3, "WL_LDO3", "vin34", 1372, 3412, 8,
		     WL28681_LDO3_VOUT, WL28681_VSEL_MASK, WL28681_LDO_EN,
		     BIT(2), BIT(2), 0, wl28681_crtable3, WL28681_ILIM, BIT(2),
		     1),
	WL28681_DESC(WL28681_REGULATOR_LDO4, "WL_LDO4", "vin34", 1372, 3412, 8,
		     WL28681_LDO4_VOUT, WL28681_VSEL_MASK, WL28681_LDO_EN,
		     BIT(3), BIT(3), 0, wl28681_crtable4, WL28681_ILIM, BIT(3),
		     1),
	WL28681_DESC(WL28681_REGULATOR_LDO5, "WL_LDO5", "vin5", 1372, 3412, 8,
		     WL28681_LDO5_VOUT, WL28681_VSEL_MASK, WL28681_LDO_EN,
		     BIT(4), BIT(4), 0, wl28681_crtable5, WL28681_ILIM, BIT(4),
		     1),
	WL28681_DESC(WL28681_REGULATOR_LDO6, "WL_LDO6", "vin6", 1372, 3412, 8,
		     WL28681_LDO6_VOUT, WL28681_VSEL_MASK, WL28681_LDO_EN,
		     BIT(5), BIT(5), 0, wl28681_crtable6, WL28681_ILIM, BIT(5),
		     1),
	WL28681_DESC(WL28681_REGULATOR_LDO7, "WL_LDO7", "vin7", 1372, 3412, 8,
		     WL28681_LDO7_VOUT, WL28681_VSEL_MASK, WL28681_LDO_EN,
		     BIT(6), BIT(6), 0, wl28681_crtable7, WL28681_ILIM, BIT(6),
		     1),
};

static const struct regulator_desc wl28681_reg_j[] = {
	WL28681_DESC(WL28681_REGULATOR_LDO1 + WL28681_MAX_REGULATORS,
		     "WL_LDO1_j", "vin12", 496, 2048, 8, WL28681_LDO1_VOUT,
		     WL28681_VSEL_MASK, WL28681_LDO_EN, BIT(0), BIT(0), 0,
		     wl28681_crtable1, WL28681_ILIM, BIT(0), 61),
	WL28681_DESC(WL28681_REGULATOR_LDO2 + WL28681_MAX_REGULATORS,
		     "WL_LDO2_j", "vin12", 496, 2048, 8, WL28681_LDO2_VOUT,
		     WL28681_VSEL_MASK, WL28681_LDO_EN, BIT(1), BIT(1), 0,
		     wl28681_crtable2, WL28681_ILIM, BIT(1), 61),
	WL28681_DESC(WL28681_REGULATOR_LDO3 + WL28681_MAX_REGULATORS,
		     "WL_LDO3_j", "vin34", 1372, 3412, 8, WL28681_LDO3_VOUT,
		     WL28681_VSEL_MASK, WL28681_LDO_EN, BIT(2), BIT(2), 0,
		     wl28681_crtable3, WL28681_ILIM, BIT(2), 1),
	WL28681_DESC(WL28681_REGULATOR_LDO4 + WL28681_MAX_REGULATORS,
		     "WL_LDO4_j", "vin34", 1372, 3412, 8, WL28681_LDO4_VOUT,
		     WL28681_VSEL_MASK, WL28681_LDO_EN, BIT(3), BIT(3), 0,
		     wl28681_crtable4, WL28681_ILIM, BIT(3), 1),
	WL28681_DESC(WL28681_REGULATOR_LDO5 + WL28681_MAX_REGULATORS,
		     "WL_LDO5_j", "vin5", 1372, 3412, 8, WL28681_LDO5_VOUT,
		     WL28681_VSEL_MASK, WL28681_LDO_EN, BIT(4), BIT(4), 0,
		     wl28681_crtable5, WL28681_ILIM, BIT(4), 1),
	WL28681_DESC(WL28681_REGULATOR_LDO6 + WL28681_MAX_REGULATORS,
		     "WL_LDO6_j", "vin6", 1372, 3412, 8, WL28681_LDO6_VOUT,
		     WL28681_VSEL_MASK, WL28681_LDO_EN, BIT(5), BIT(5), 0,
		     wl28681_crtable6, WL28681_ILIM, BIT(5), 1),
	WL28681_DESC(WL28681_REGULATOR_LDO7 + WL28681_MAX_REGULATORS,
		     "WL_LDO7_j", "vin7", 1372, 3412, 8, WL28681_LDO7_VOUT,
		     WL28681_VSEL_MASK, WL28681_LDO_EN, BIT(6), BIT(6), 0,
		     wl28681_crtable7, WL28681_ILIM, BIT(6), 1),
};
...
static int wl2868_regulator_enable_regmap(struct regulator_dev *rdev)
{
	...
	do {
		...
		if (ret) {
			...
			dev_info(
				dev,
				"wait 1ms for LDO_EN read_data %0x ldo_en 0x%x\n",
		...
		if (count == (max_read_count / 2)) {
			dev_err(dev,
				"retry 5 time no enable reg so enable ldo again");
			ret = regulator_enable_regmap(rdev);
			if (ret) {
				dev_err(dev, "Set reg enable error %d", ret);
				break;
...
static void wl28681_i2c_enable(struct wl28681 *wl28681)
{
	...
	usleep_range(10000, 11000);
	for (i = 0; i < 3; i++) {
		ret = regmap_read(wl28681->regmap,
				  WL28681_REPROGRAMMABLE_I2C_ADDR, &tmp_data);
		if (ret) {
			dev_err(wl28681->dev,
				"i2c enable set error, start rest retry %d\n",
				i);
			wl28681_reset(wl28681);
		} else {
			dev_info(wl28681->dev,
				 "i2c enable set success, I2C ADDR REG: 0x%x\n",
				 tmp_data);
			break;
		}
	}
...
static int wl28681_i2c_probe(struct i2c_client *client)
{
	...
	if (1 < atomic_add_return(1, &probe_cnt)) {
		do {
			...
			sleep_cnt++;
			dev_info(dev,
				 "wait 10ms for other wl2868 probe cnt: %d\n",
				 sleep_cnt);
			if (1 >= atomic_read(&probe_cnt)) {
				dev_info(
					dev,
					"wait success for other wl2868 probe\n");
				break;
			}
		} while (sleep_cnt < 50);
	}
	...
	if (WL28681_DEFAULT_SLAVE_ADDR != client->addr) {
		...
		if (0 >
		    i2c_smbus_write_byte_data(
			    client, WL28681_REPROGRAMMABLE_I2C_ADDR, 0x02)) {
			dev_err(dev, "write i2c addr 0x%x failed!",
				client->addr);
		}
	...
	ret = regmap_read(wl28681->regmap, WL28681_TSD_UVLO_INT_MASK,
			  &tmp_data);
