...
static ssize_t enable_show(const struct class *class, const struct class_attribute *attr,
                            char *buf)
{
	return sprintf(buf, "%d\n",ois_vdd_info->enable);
}

static ssize_t enable_store(const struct class *class, const struct class_attribute *attr,
